...
/* Backward-compatible COPY aliases for the generalized stream function codes.
 * Wire values are unchanged: the aliases resolve to the same enumerators. */
