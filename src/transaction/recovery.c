...
struct rvfun RV_fun[] = {
  ...
  /* R-tree (spatial index) recovery */
  {RVRT_NEW_PAGE,
   "RVRT_NEW_PAGE",
   pgbuf_rv_new_page_undo,
   rtree_rv_redo_new_page,
   NULL,
   NULL},
  {RVRT_LEAF_INSERT,
   "RVRT_LEAF_INSERT",
   rtree_rv_undo_leaf_insert,
   rtree_rv_redo_leaf_insert,
   NULL,
   NULL},
  {RVRT_LEAF_DELETE,
   "RVRT_LEAF_DELETE",
   rtree_rv_undo_leaf_delete,
   rtree_rv_redo_leaf_delete,
   NULL,
   NULL},
  {RVRT_NONLEAF_INSERT,
   "RVRT_NONLEAF_INSERT",
   rtree_rv_undo_nonleaf_insert,
   rtree_rv_redo_nonleaf_insert,
   NULL,
   NULL},
  {RVRT_NONLEAF_DELETE,
   "RVRT_NONLEAF_DELETE",
   rtree_rv_undo_nonleaf_delete,
   rtree_rv_redo_nonleaf_delete,
   NULL,
   NULL},
  {RVRT_NONLEAF_UPDATE,
   "RVRT_NONLEAF_UPDATE",
   rtree_rv_undoredo_nonleaf_update,
   rtree_rv_undoredo_nonleaf_update,
   NULL,
   NULL},
  {RVRT_NODE_HEADER_UPD,
   "RVRT_NODE_HEADER_UPD",
   rtree_rv_undoredo_node_header,
   rtree_rv_undoredo_node_header,
   NULL,
   NULL},
  {RVRT_ROOT_HEADER_UPD,
   "RVRT_ROOT_HEADER_UPD",
   rtree_rv_undoredo_root_header,
   rtree_rv_undoredo_root_header,
   NULL,
   NULL},
};
