...
namespace cubhnsw
{
  ...
  class algo
  {
	...
	return metric_table[static_cast<size_t> (m_metric)] (v1, v2, m_dimension);
      ...
      inline const float *get_vector_cached_ (algo_context_t &context, const slot_id_t &slot) const
      {
	...
	return neighbors;
      ...
      mutable vector_cache_t m_vector_cache;  // (slot_id_t, vector) to avoid repeated page fix/unfix
