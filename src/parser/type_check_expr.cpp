...
type_check_expr_helper::do_type_checking ()
{
  ...
  if ((code = adjust_expression_def (m_common_type, m_expr)) != NO_ERROR || m_is_finished)
    {
      goto exit;
    }
...
int
type_check_expr_helper::adjust_expression_def (PT_TYPE_ENUM &common_type, PT_NODE *expr)
{
