...
pt_eval_expr_type (PARSER_CONTEXT * parser, PT_NODE * node)
{
  ...
  arg1_type = expr_helper.m_arg1_type;
  arg2_type = expr_helper.m_arg2_type;
  arg3_type = expr_helper.m_arg3_type;

  arg1_hv = expr_helper.m_arg1_hv;
  arg2_hv = expr_helper.m_arg1_hv;
  arg3_hv = expr_helper.m_arg1_hv;

  arg1 = node->info.expr.arg1;
  arg2 = node->info.expr.arg2;
  arg3 = node->info.expr.arg3;
  expr = expr_helper.m_expr;
...
pt_fix_arguments_collation_flag (PT_NODE * expr)
{
  ...
  for (i = 0; i < (int) def.sigs.size (); i++)
	...
	{
	  arg_curr_sig_type = pt_get_equivalent_type (def.sigs[i].arg1_type, expr->info.expr.arg1->type_enum);
	...
	{
	  arg_curr_sig_type = pt_get_equivalent_type (def.sigs[i].arg2_type, expr->info.expr.arg2->type_enum);
	...
	{
	  arg_curr_sig_type = pt_get_equivalent_type (def.sigs[i].arg3_type, expr->info.expr.arg3->type_enum);
