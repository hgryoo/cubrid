...
static KEYWORD_RECORD keywords[] = {
  ...
  {DISTINCT, "DISTINCT", 0},
  {DISTINCT, "DISTINCTROW", 0},
  {DIV, "DIV", 0},
  {DO, "DO", 0},
  {Domain, "DOMAIN", 0},
  {DONT_REUSE_OID, "DONT_REUSE_OID", 1},
  {Double, "DOUBLE", 0},
  {DROP, "DROP", 0},
  ...
  {GEOMETRYCOLLECTION, "GEOMETRYCOLLECTION", 0},
  {GE_INF_, "GE_INF", 1},
  {GE_LE_, "GE_LE", 1},
  {GE_LT_, "GE_LT", 1},
  {GEOMETRY, "GEOMETRY", 0},
  ...
  {JOIN, "JOIN", 0},
  {JOB, "JOB", 1},
  {JSON_ARRAYAGG, "JSON_ARRAYAGG", 1},
  {JSON_ARRAY_APPEND, "JSON_ARRAY_APPEND", 1},
  {JSON_ARRAY_INSERT, "JSON_ARRAY_INSERT", 1},
  {JSON_ARRAY_LEX, "JSON_ARRAY", 1},
  {JSON_CONTAINS, "JSON_CONTAINS", 1},
  {JSON_CONTAINS_PATH, "JSON_CONTAINS_PATH", 1},
  {JSON_DEPTH, "JSON_DEPTH", 1},
  {JSON_EXTRACT, "JSON_EXTRACT", 1},
  {JSON_GET_ALL_PATHS, "JSON_GET_ALL_PATHS", 1},
  {JSON_INSERT, "JSON_INSERT", 1},
  {JSON, "JSON", 0},
  {JSON_KEYS, "JSON_KEYS", 1},
  {JSON_LENGTH, "JSON_LENGTH", 1},
  {JSON_MERGE, "JSON_MERGE", 1},
  {JSON_MERGE_PATCH, "JSON_MERGE_PATCH", 1},
  {JSON_MERGE_PRESERVE, "JSON_MERGE_PRESERVE", 1},
  {JSON_OBJECTAGG, "JSON_OBJECTAGG", 1},
  {JSON_OBJECT_LEX, "JSON_OBJECT", 1},
  {JSON_PRETTY, "JSON_PRETTY", 1},
  {JSON_QUOTE, "JSON_QUOTE", 1},
  {JSON_REMOVE, "JSON_REMOVE", 1},
  {JSON_REPLACE, "JSON_REPLACE", 1},
  {JSON_SEARCH, "JSON_SEARCH", 1},
  {JSON_SET, "JSON_SET", 1},
  {JSON_TABLE, "JSON_TABLE", 1},
  {JSON_TYPE, "JSON_TYPE", 1},
  {JSON_UNQUOTE, "JSON_UNQUOTE", 1},
  ...
  {Monetary, "MONETARY", 0},
  {MONTH_, "MONTH", 0},
  {MULTILINESTRING, "MULTILINESTRING", 0},
  {MULTISET, "MULTISET", 0},
  {MULTIPOINT, "MULTIPOINT", 0},
  ...
  {REGEXP_COUNT, "REGEXP_COUNT", 1},
  {REGEXP_INSTR, "REGEXP_INSTR", 1},
  {REGEXP_LIKE, "REGEXP_LIKE", 1},
  {REGEXP, "REGEXP", 1},
  {REGEXP_REPLACE, "REGEXP_REPLACE", 1},
  {REGEXP_SUBSTR, "REGEXP_SUBSTR", 1},
  {REJECT_, "REJECT", 1},
  {RELATIVE_, "RELATIVE", 0},
  {REMOVE, "REMOVE", 1},
  {RENAME, "RENAME", 0},
  ...
  {SERVER, "SERVER", 1},
  {SESSION, "SESSION", 0},
  {SESSION_TIMEZONE, "SESSIONTIMEZONE", 1},
 ...
 */
  ...
  {0, "st_affine", F_ST_AFFINE},
  {0, "st_area", F_ST_AREA},
  {0, "st_area_spheroid", F_ST_AREA_SPHEROID},
  {0, "st_asgeojson", F_ST_ASGEOJSON},
  {0, "st_ashexwkb", F_ST_ASHEXWKB},
  {0, "st_assvg", F_ST_ASSVG},
  {0, "st_astext", F_ST_ASTEXT},
  {0, "st_aswkb", F_ST_ASWKB},
  {0, "st_asbinary", F_ST_ASBINARY},
  {0, "st_azimuth", F_ST_AZIMUTH},
  {0, "st_boundary", F_ST_BOUNDARY},
  {0, "st_buffer", F_ST_BUFFER},
  {0, "st_buildarea", F_ST_BUILDAREA},
  {0, "st_centroid", F_ST_CENTROID},
  {0, "st_collect", F_ST_COLLECT},
  {0, "st_collectionextract", F_ST_COLLECTIONEXTRACT},
  {0, "st_concavehull", F_ST_CONCAVEHULL},
  {0, "st_contains", F_ST_CONTAINS},
  {0, "st_containsproperly", F_ST_CONTAINSPROPERLY},
  {0, "st_convexhull", F_ST_CONVEXHULL},
  {0, "st_coverageinvalidedges", F_ST_COVERAGEINVALIDEDGES},
  {0, "st_coveragesimplify", F_ST_COVERAGESIMPLIFY},
  {0, "st_coverageunion", F_ST_COVERAGEUNION},
  {0, "st_coveredby", F_ST_COVEREDBY},
  {0, "st_covers", F_ST_COVERS},
  {0, "st_crosses", F_ST_CROSSES},
  {0, "st_dwithin", F_ST_DWITHIN},
  {0, "st_dwithin_geos", F_ST_DWITHIN_GEOS},
  {0, "st_dwithin_spheroid", F_ST_DWITHIN_SPHEROID},
  {0, "st_difference", F_ST_DIFFERENCE},
  {0, "st_dimension", F_ST_DIMENSION},
  {0, "st_disjoint", F_ST_DISJOINT},
  {0, "st_distance", F_ST_DISTANCE},
  {0, "st_distance_geos", F_ST_DISTANCE_GEOS},
  {0, "st_distance_sphere", F_ST_DISTANCE_SPHERE},
  {0, "st_distance_spheroid", F_ST_DISTANCE_SPHEROID},
  {0, "st_dump", F_ST_DUMP},
  {0, "st_endpoint", F_ST_ENDPOINT},
  {0, "st_envelope", F_ST_ENVELOPE},
  {0, "st_equals", F_ST_EQUALS},
  {0, "st_extent", F_ST_EXTENT},
  {0, "st_extent_approx", F_ST_EXTENT_APPROX},
  {0, "st_exteriorring", F_ST_EXTERIORRING},
  {0, "st_flipcoordinates", F_ST_FLIPCOORDINATES},
  {0, "st_force2d", F_ST_FORCE2D},
  {0, "st_force3dm", F_ST_FORCE3DM},
  {0, "st_force3dz", F_ST_FORCE3DZ},
  {0, "st_force4d", F_ST_FORCE4D},
  {0, "st_geomfromgeojson", F_ST_GEOMFROMGEOJSON},
  {0, "st_geomfromhexewkb", F_ST_GEOMFROMHEXEWKB},
  {0, "st_geomfromhexwkb", F_ST_GEOMFROMHEXWKB},
  {0, "st_geomfromtext", F_ST_GEOMFROMTEXT},
  {0, "st_geomfromwkb", F_ST_GEOMFROMWKB},
  {0, "st_geometrytype", F_ST_GEOMETRYTYPE},
  {0, "st_hasm", F_ST_HASM},
  {0, "st_hasz", F_ST_HASZ},
  {0, "st_hilbert", F_ST_HILBERT},
  {0, "st_intersection", F_ST_INTERSECTION},
  {0, "st_intersects", F_ST_INTERSECTS},
  {0, "st_intersects_extent", F_ST_INTERSECTS_EXTENT},
  {0, "st_isclosed", F_ST_ISCLOSED},
  {0, "st_isempty", F_ST_ISEMPTY},
  {0, "st_isring", F_ST_ISRING},
  {0, "st_issimple", F_ST_ISSIMPLE},
  {0, "st_isvalid", F_ST_ISVALID},
  {0, "st_length", F_ST_LENGTH},
  {0, "st_length_spheroid", F_ST_LENGTH_SPHEROID},
  {0, "st_lineinterpolatepoint", F_ST_LINEINTERPOLATEPOINT},
  {0, "st_lineinterpolatepoints", F_ST_LINEINTERPOLATEPOINTS},
  {0, "st_linemerge", F_ST_LINEMERGE},
  {0, "st_linestring2dfromwkb", F_ST_LINESTRING2DFROMWKB},
  {0, "st_linesubstring", F_ST_LINESUBSTRING},
  {0, "st_m", F_ST_M},
  {0, "st_mmax", F_ST_MMAX},
  {0, "st_mmin", F_ST_MMIN},
  {0, "st_makeenvelope", F_ST_MAKEENVELOPE},
  {0, "st_makeline", F_ST_MAKELINE},
  {0, "st_makepolygon", F_ST_MAKEPOLYGON},
  {0, "st_makevalid", F_ST_MAKEVALID},
  {0, "st_maximuminscribedcircle", F_ST_MAXIMUMINSCRIBEDCIRCLE},
  {0, "st_minimumrotatedrectangle", F_ST_MINIMUMROTATEDRECTANGLE},
  {0, "st_multi", F_ST_MULTI},
  {0, "st_ngeometries", F_ST_NGEOMETRIES},
  {0, "st_ninteriorrings", F_ST_NINTERIORRINGS},
  {0, "st_npoints", F_ST_NPOINTS},
  {0, "st_node", F_ST_NODE},
  {0, "st_normalize", F_ST_NORMALIZE},
  {0, "st_numgeometries", F_ST_NUMGEOMETRIES},
  {0, "st_numinteriorrings", F_ST_NUMINTERIORRINGS},
  {0, "st_numpoints", F_ST_NUMPOINTS},
  {0, "st_overlaps", F_ST_OVERLAPS},
  {0, "st_perimeter", F_ST_PERIMETER},
  {0, "st_perimeter_spheroid", F_ST_PERIMETER_SPHEROID},
  {0, "st_point", F_ST_POINT},
  {0, "st_point2d", F_ST_POINT2D},
  {0, "st_point2dfromwkb", F_ST_POINT2DFROMWKB},
  {0, "st_point3d", F_ST_POINT3D},
  {0, "st_point4d", F_ST_POINT4D},
  {0, "st_pointn", F_ST_POINTN},
  {0, "st_pointonsurface", F_ST_POINTONSURFACE},
  {0, "st_points", F_ST_POINTS},
  {0, "st_polygon2dfromwkb", F_ST_POLYGON2DFROMWKB},
  {0, "st_polygonize", F_ST_POLYGONIZE},
  {0, "st_quadkey", F_ST_QUADKEY},
  {0, "st_reduceprecision", F_ST_REDUCEPRECISION},
  {0, "st_removerepeatedpoints", F_ST_REMOVEREPEATEDPOINTS},
  {0, "st_reverse", F_ST_REVERSE},
  {0, "st_setsrid", F_ST_SETSRID},
  {0, "st_shortestline", F_ST_SHORTESTLINE},
  {0, "st_simplify", F_ST_SIMPLIFY},
  {0, "st_simplifypreservetopology", F_ST_SIMPLIFYPRESERVETOPOLOGY},
  {0, "st_srid", F_ST_SRID},
  {0, "st_startpoint", F_ST_STARTPOINT},
  {0, "st_tileenvelope", F_ST_TILEENVELOPE},
  {0, "st_touches", F_ST_TOUCHES},
  {0, "st_transform", F_ST_TRANSFORM},
  {0, "st_union", F_ST_UNION},
  {0, "st_voronoidiagram", F_ST_VORONOIDIAGRAM},
  {0, "st_within", F_ST_WITHIN},
  {0, "st_withinproperly", F_ST_WITHINPROPERLY},
  {0, "st_x", F_ST_X},
  {0, "st_xmax", F_ST_XMAX},
  {0, "st_xmin", F_ST_XMIN},
  {0, "st_y", F_ST_Y},
