...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_NEIGHBORS_CACHE_HIT, "Num_hnsw_neighbors_cache_hit_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_NEIGHBORS_PAGE_FIX, "Num_hnsw_neighbors_page_fix_l0"),
