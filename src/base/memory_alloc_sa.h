...
/*
 * memory_alloc_sa.h - Memory allocation module to define functions for SA mode 
 */

#ifndef _MEMORY_ALLOC_SA_H_
#define _MEMORY_ALLOC_SA_H_
...
extern void *db_standalone_alloc (HL_HEAPID & heap_id, private_alloc_type alloc_type, size_t size);
extern void *db_standalone_realloc (void *ptr, size_t size);
extern void db_standalone_free (void *ptr);

#endif /* _MEMORY_ALLOC_SA_H_ */