...
#define SM_MAP_INDEX_ATTFLAG_TO_CONSTRAINT(c) \
	...
	(c) == SM_ATTFLAG_RTREE_INDEX    ? SM_CONSTRAINT_RTREE_INDEX : \
...
#define SM_MAP_CONSTRAINT_TO_ATTFLAG(c) \
	...
	(c) == DB_CONSTRAINT_RTREE_INDEX    ? SM_ATTFLAG_RTREE_INDEX: \
...
#define SM_MAP_DB_INDEX_CONSTRAINT_TO_SM_CONSTRAINT(c) \
	...
	(c) == DB_CONSTRAINT_RTREE_INDEX    ? SM_CONSTRAINT_RTREE_INDEX: \
...
#define SM_GET_CONSTRAINT_STRING(c) \
	...
	(c) == DB_CONSTRAINT_RTREE_INDEX    ? "RTREE INDEX": \
